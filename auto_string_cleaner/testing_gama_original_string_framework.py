...
from original_auto_string_cleaner import main as original_main
import openml as oml
import traceback
import pickle

METHOD = 'original_string_framework'

if __name__ == '__main__':

    list_of_datasets = [
        # 31, 1464, 334, 50, 333, 1504, 3, 1494, 1510, 1489, 37, 1063, 1467,1067, 1480, 1068, 1050,
        # 1462,1049, 335, 42, 18, 1555, 22, 54,
        182, 11, 15, 469, 188, 307, 4538, 1497, 29,
    ...
    for dataset_id in list_of_datasets:
        ...
        try:
            X, y = original_main.run(data=X, y=y, dense_encoding=False)
        except Exception:
        ...
        try:
            automl = GamaClassifier(max_total_time=300, store="nothing")
